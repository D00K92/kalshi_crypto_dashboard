...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            feature_stream=os.getenv("FEATURE_STREAM", "stream:features:v2_10s"),
            feature_key=os.getenv("FEATURE_KEY", "market:features:v2_10s:BTCUSD:latest"),
            state_key=os.getenv("FEATURE_STATE_KEY", "market:features:BTCUSD:state:v2_10s"),
            consumer_group=os.getenv("LIVE_FEATURE_GROUP", "live-features-v2-10s"),
