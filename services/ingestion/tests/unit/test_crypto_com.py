...
def test_parse_trade() -> None:
    events = parse_crypto_com_message(json.dumps({"result": {"channel": "trade", "instrument_name": "BTC_USD", "data": [{"s": "BUY", "p": "100000.10", "q": "0.001", "t": 1700000000000, "d": "123"}]}}), received_ts_ms=2)
...
def test_parse_book_snapshot() -> None:
    events = parse_crypto_com_message(json.dumps({"result": {"channel": "book", "instrument_name": "BTC_USD", "u": 160, "data": [{"bids": [["100000.00", "1.5", "0"]], "asks": [["100001.00", "1.2", "0"]]}]}}), received_ts_ms=2)
