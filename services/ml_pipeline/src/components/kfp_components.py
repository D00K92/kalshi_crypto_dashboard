...
# Container-component definitions used by the production Vertex pipeline.
LOAD_IMAGE = "asia-northeast3-docker.pkg.dev/kalshi-crypto-506614/ml-pipeline/ml-load:v1"
TRAIN_IMAGE = "asia-northeast3-docker.pkg.dev/kalshi-crypto-506614/ml-pipeline/ml-train:v1"
EVALUATE_IMAGE = "asia-northeast3-docker.pkg.dev/kalshi-crypto-506614/ml-pipeline/ml-evaluate:v1"
REGISTER_IMAGE = "asia-northeast3-docker.pkg.dev/kalshi-crypto-506614/ml-pipeline/ml-register:v1"
