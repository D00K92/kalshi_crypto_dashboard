-- BigQuery-native future realized-volatility labels from the 10s synthetic price.
...
WHEN NOT MATCHED THEN INSERT (
  ...
  target_rv_5m, target_rv_15m, target_rv_30m, target_rv_1h,
  label_version
) VALUES (
  source.market_id, source.prediction_timestamp, source.label_window_end,
  source.label_created_timestamp, source.target_rv_5m,
